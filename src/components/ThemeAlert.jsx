...
const ThemeAlert = ({ targetDate, programName, handleClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-6">
      <div className="relative bg-white dark:bg-zinc-800 p-6 rounded-lg shadow-xl max-w-md w-full transform transition-all">
        <button
          onClick={handleClose}
        ...
        <div className="text-center">
          ...
          <div className="mt-6 flex justify-center gap-3">
            <div className="flex flex-col items-center p-2 bg-zinc-100 dark:bg-zinc-700 rounded min-w-[60px]">
          ...
          {/* <div className="mt-6 flex gap-4 justify-center">
            ...
            <button
              ...
              className="px-6 py-2 bg-zinc-200 dark:bg-zinc-700 text-zinc-800  rounded-md hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors font-medium"
            >
              Remind Me Later
            </button>
          </div> */}
